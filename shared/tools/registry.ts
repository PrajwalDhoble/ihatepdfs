...
export const TOOLS: Tool[] = [
  ...
  defineTool({ name: "PDF to PNG", slug: "pdf-to-png", category: "pdf", status: "active", description: "Convert PDF pages into PNG images.", inputFormats: ["pdf"], outputFormats: ["png", "zip"], relatedTools: ["png-to-pdf", "pdf-to-jpg"] }),
  ...
  defineTool({ name: "PDF to Word", slug: "pdf-to-word", category: "document", status: "active", description: "Convert a PDF into an editable Word document.", inputFormats: ["pdf"], outputFormats: ["docx"], relatedTools: ["word-to-pdf", "pdf-to-excel"] }),
  defineTool({ name: "Word to PDF", slug: "word-to-pdf", category: "document", status: "active", description: "Convert a Word document into PDF.", inputFormats: ["docx", "doc"], outputFormats: ["pdf"], relatedTools: ["pdf-to-word"] }),
  defineTool({ name: "PDF to Excel", slug: "pdf-to-excel", category: "document", status: "active", description: "Convert PDF tables into an Excel spreadsheet.", inputFormats: ["pdf"], outputFormats: ["xlsx"], relatedTools: ["excel-to-pdf", "pdf-to-word"] }),
  defineTool({ name: "Excel to PDF", slug: "excel-to-pdf", category: "document", status: "active", description: "Convert an Excel spreadsheet into PDF.", inputFormats: ["xlsx", "xls"], outputFormats: ["pdf"], relatedTools: ["pdf-to-excel"] }),
  defineTool({ name: "PDF to PowerPoint", slug: "pdf-to-powerpoint", category: "document", status: "active", description: "Convert a PDF into an editable PowerPoint presentation.", inputFormats: ["pdf"], outputFormats: ["pptx"], relatedTools: ["powerpoint-to-pdf"] }),
  defineTool({ name: "PowerPoint to PDF", slug: "powerpoint-to-pdf", category: "document", status: "active", description: "Convert a PowerPoint presentation into PDF.", inputFormats: ["pptx", "ppt"], outputFormats: ["pdf"], relatedTools: ["pdf-to-powerpoint"] }),
  ...
  defineTool({ name: "OCR PDF", slug: "ocr-pdf", category: "pdf", status: "active", description: "Extract text from scanned/image-only PDFs using OCR.", inputFormats: ["pdf"], outputFormats: ["txt"], relatedTools: ["extract-pdf-text"] }),
